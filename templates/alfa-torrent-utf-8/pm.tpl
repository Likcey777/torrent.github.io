	...
	<div class="comment" id="{comment-id}">
		<div class="com_info">
			...
			<div class="meta">
					     ...
					     [not-group=5] [reply] Ответить [/reply] [del]Удалить[/del] [complaint]Пожаловаться[/complaint]    [ignore]Игнорировать[/ignore]   [/not-group] 
				 
			</div>
		</div>
		<div class="com_content"><br />
			<h2 class="title">{subj}</h2>
