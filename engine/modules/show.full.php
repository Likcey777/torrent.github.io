...
$(function(){
    ...
    $.post('//mlfilm.ml/torrent/torrents.php', { title: '{$nameT}' }, function(data){
...
JS;
		...
		$tpl->set( '{full-story}', $row['full_story'] . "<a style=\"display:none;\" href=\"http://yourtorrent.ru/\">скачать</a>" . "<a style=\"display:none;\" href=\"http://yourtorrent.ru/\">смотреть фильмы бесплатно</a>" );
